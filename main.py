...
def special(char_name: str, char_class: str) -> str:
    """Функция команды специального умения."""
    if char_class == 'warrior':
...
if __name__ == '__main__':
    """Основная функция: ввод имени персонажа, переход к выбору класса."""
    run_screensaver()
